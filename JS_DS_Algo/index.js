...
console.log(DP.matrixChain([1,2 , 3, 4]), "Matrix");
...
console.log(DP.editDistance('sunday','saturday'));
console.log(DP.editDistanceDP('sunday','saturday'));
console.log(DP.optimalStratergyForGame([ 2, 2, 2, 2]));